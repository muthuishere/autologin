...
var autoLoginAuth={
	...
	showAuthDialog:function(){
		...
		//.
		for(i=0;i<document.querySelector("body").children.length;i++){
    ...
    y = w.innerHeight|| e.clientHeight|| g.clientHeight;
		...
		myString="<iframe src=" + chrome.extension.getURL("auth.html") +" style='position:fixed;zIndex:1000;top:0px;left:0px;width:"+x+"px;height:"+y+"px'></iframe>"		
