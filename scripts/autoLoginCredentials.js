var autoLoginCredentials={
	...
	setPassword:function(){
		...
		document.body.appendChild(container)
		 document.querySelector("input#btnaskpassword").addEventListener('submit', autoLoginCredentials.onClickActivateButton, false);
	...
	onClickActivateButton:function(){
		...
		var curpwd=document.getElementById("txtaskpassword").value;
	 	chrome.extension.sendMessage({action: "validateCredential",info:curpwd}, function(response) {
				...
				document.querySelector("span#autologinmsg").innerHTML="* Invalid Credentials"
				}
